var myBot = new BotUI('hello-world');
    ...
    myBot.message.add({ // show a message
      delay: 200,
      content: 'Hello, my name is tanhao.'
    }).then (function (){
      myBot.message.add({
        delay: 1000,
        loading: true,
      ...
      switch (res.value) {
        ...
        case 'your contacts':
          ...
          delay: 1000,
          loading: true,
          content: `Go ahead, try [my website](https://ietanhao.github.io) or <a href="mailto:realtanhao@gmail.com">Email me.</a> </br>`
        });
        break;/*
        case 'your hobbies':
          return myBot.message.add ({
      ...
      switch (res.value) {
        case 'yes':
          return myBot.message.add({
            delay: 1000,
            loading: true,
            content: `i'm sorry! i don't love you because i have my love.`
          })
          ...
          case 'no':
            return myBot.message.add({
              delay: 1000,
              loading: true,
              content: `i don't love you too, because i have my love.`
            })
        default:
